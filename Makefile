...
# Backend commands
.PHONY: start-backend test-backend setup-test migrate-db generate-migration seed-db
...
setup-test: ## Verify that setup completed successfully
	cd $(BACKEND_DIR) && PYTHONPATH=. uv run python3 commands/verify_setup.py
